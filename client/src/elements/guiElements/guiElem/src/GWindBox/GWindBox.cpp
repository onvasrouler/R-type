...
GWindBox::GWindBox(const Vector2 pos, const Vector2 size, const std::string text, const std::string id, const bool isOpened, const bool display) : AGuiElem(pos, size, text, id, display)
{
