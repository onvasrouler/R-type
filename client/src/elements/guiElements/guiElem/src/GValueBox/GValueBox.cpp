...
GValueBox::GValueBox(const Vector2 pos, const Vector2 size, const std::string text, const std::string id, int value, int minValue, int maxValue, const bool editMode, const bool display) : AGuiElem(pos, size, text, id, display)
{
    this->_Value = value;
