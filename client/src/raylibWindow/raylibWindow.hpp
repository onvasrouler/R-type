...
class RlibWindow {
     ...
     */
    RlibWindow(const int _WindowWidth = 800,const int _WindowHeight = 600, std::string title = "r-type", Color backgroundColor = WHITE,const int frameRateLimit = 60);
